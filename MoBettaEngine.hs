...
= liftA2 (opLookup op bBinOps) (boolCalc epr1) (boolCalc expr2)
boolCalc (BUn op expr) 
= fmap (opLookup op bUnOps) (boolCalc expr2)

intCalc :: AExpr -> IntCalc
intCalc (Var v) = retrieveEnv v
intCalc (IntConst val) = return val
intCalc (ABin op expr1 expr2) = liftA2 (opLookup op aBinOps) (intCalc expr2)
